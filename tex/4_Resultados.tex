...
\section{Modelo 4}
\label{res:mod4}
Para este modelo foram usadas as bases \textbf{BD2}, \textbf{BD3} e \textbf{BD4} como treino. Além disso, o modelo possui 10 níveis de resíduos. Para o JPEG e JPEG2000 são utilizados a melhor aproximação possível da \acrshort{BPP} obtida pela rede (network), ou seja, a melhor \textit{quality} que se adequa à \acrshort{BPP} desejada.
...
\textbf{10}    & 1.23, 33.65      & 1.22, 33.72   & 1.21, 35.37     \\ \hline}
...
\textbf{10}    & 1.23, 0.92873       & 1.22, 0.91712    & 1.21, 0.92769      \\ \hline}
...
\textbf{10}    & 1.23, 0.98665      & 1.22, 0.98381   & 1.21, 0.98807     \\ \hline}

\figura[!htb]{_mean_plot_psnr_10levels}{Comparação do Modelo 4 com o JPEG e JPEG2000 na métrica \acrshort{PSNR} em diferentes taxas}{_mean_plot_psnr_10levels}{width=0.7\textwidth}
\figura[!htb]{_mean_plot_ssim_10levels}{Comparação do Modelo 4 com o JPEG e JPEG2000 na métrica \acrshort{SSIM} em diferentes taxas}{_mean_plot_ssim_10levels}{width=0.7\textwidth}
\figura[!htb]{_mean_plot_msssim_10levels}{Comparação do Modelo 4 com o JPEG e JPEG2000 na métrica \acrshort{MS-SSIM} em diferentes taxas}{_mean_plot_msssim_10levels}{width=0.7\textwidth}
