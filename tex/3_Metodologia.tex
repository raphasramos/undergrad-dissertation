...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% O binarizador $B$ proposto neste trabalho difere do \textit{Toderici} em questão de implementação (explicado na % subseção~\ref{variablerate}) na função de binarização $b$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{cases}}
% Em tempo de teste é utilizada a seguinte função: \equacao{b_inf2}{\hat{b}^{inf}(x) = \begin{cases}
% -1,\, \text{ se } x < 0,\\
% 0,\, \text{ se } x = 0,\\
% 1,\, \text{ caso contrário.}\\
% \end{cases}}
