...
Para os modelos que usam mais de 1 nível de resíduo, a taxa nominal é acrescida de 0.125 bits por pixel para cada nível. Com o uso do \textit{gzip} reduz-se a taxa nominal para cada nível em cerca de 20\%.
